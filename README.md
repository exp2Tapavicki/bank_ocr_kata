...
---
Coding task description can be found on the following link or text bellow. 
https://codingdojo.org/kata/BankOCR/

I have done both implementation(iterative and recursive) for guessing alternative digit.
